...
process KREWLYZER_RUNALL {
    ...
    tuple val(meta), path("*.FSC.tsv.gz"),           emit: fsc_gz, optional: true
    ...
    tuple val(meta), path("*.FSC.ontarget.tsv.gz"),  emit: fsc_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.FSC.gene.tsv.gz"),      emit: fsc_gene_gz, optional: true
    ...
    tuple val(meta), path("*.FSC.regions.tsv.gz"),   emit: fsc_regions_gz, optional: true
    ...
    tuple val(meta), path("*.FSC.regions.e1only.tsv.gz"), emit: fsc_e1_gz, optional: true
    ...
    tuple val(meta), path("*.fsc_counts.tsv.gz"),    emit: fsc_counts_gz, optional: true
    ...
    tuple val(meta), path("*.fsc_counts.ontarget.tsv.gz"), emit: fsc_counts_ontarget_gz, optional: true
    tuple val(meta), path("*.fsc_counts.ontarget.parquet"), emit: fsc_counts_ontarget_parquet, optional: true
    
    // FSR outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.FSR.tsv"),              emit: fsr, optional: true
    tuple val(meta), path("*.FSR.tsv.gz"),           emit: fsr_gz, optional: true
    ...
    tuple val(meta), path("*.FSR.ontarget.tsv.gz"),  emit: fsr_ontarget_gz, optional: true
    tuple val(meta), path("*.FSR.ontarget.parquet"), emit: fsr_ontarget_parquet, optional: true
    
    // FSD outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.FSD.tsv"),              emit: fsd, optional: true
    tuple val(meta), path("*.FSD.tsv.gz"),           emit: fsd_gz, optional: true
    ...
    tuple val(meta), path("*.FSD.ontarget.tsv.gz"),  emit: fsd_ontarget_gz, optional: true
    ...
    // OCF outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.OCF.tsv"),              emit: ocf, optional: true
    tuple val(meta), path("*.OCF.tsv.gz"),           emit: ocf_gz, optional: true
    ...
    tuple val(meta), path("*.OCF.sync.tsv.gz"),      emit: ocf_sync_gz, optional: true
    ...
    tuple val(meta), path("*.OCF.ontarget.tsv.gz"),  emit: ocf_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.OCF.ontarget.sync.tsv.gz"), emit: ocf_ontarget_sync_gz, optional: true
    ...
    tuple val(meta), path("*.OCF.offtarget.tsv.gz"), emit: ocf_offtarget_gz, optional: true
    ...
    tuple val(meta), path("*.OCF.offtarget.sync.tsv.gz"), emit: ocf_offtarget_sync_gz, optional: true
    tuple val(meta), path("*.OCF.offtarget.sync.parquet"), emit: ocf_offtarget_sync_parquet, optional: true
    
    // Motif outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.EndMotif.tsv"),         emit: end_motif, optional: true
    tuple val(meta), path("*.EndMotif.tsv.gz"),      emit: end_motif_gz, optional: true
    ...
    tuple val(meta), path("*.EndMotif.ontarget.tsv.gz"), emit: end_motif_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.EndMotif1mer.tsv.gz"),  emit: end_motif_1mer_gz, optional: true
    ...
    tuple val(meta), path("*.BreakPointMotif.tsv.gz"), emit: bp_motif_gz, optional: true
    ...
    tuple val(meta), path("*.BreakPointMotif.ontarget.tsv.gz"), emit: bp_motif_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.MDS.tsv.gz"),           emit: mds_gz, optional: true
    ...
    tuple val(meta), path("*.MDS.ontarget.tsv.gz"),  emit: mds_ontarget_gz, optional: true
    tuple val(meta), path("*.MDS.ontarget.parquet"), emit: mds_ontarget_parquet, optional: true
    
    // TFBS/ATAC outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.TFBS.tsv"),             emit: tfbs, optional: true
    tuple val(meta), path("*.TFBS.tsv.gz"),          emit: tfbs_gz, optional: true
    ...
    tuple val(meta), path("*.TFBS.sync.tsv.gz"),     emit: tfbs_sync_gz, optional: true
    ...
    tuple val(meta), path("*.TFBS.ontarget.tsv.gz"), emit: tfbs_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.TFBS.ontarget.sync.tsv.gz"), emit: tfbs_ontarget_sync_gz, optional: true
    ...
    tuple val(meta), path("*.ATAC.tsv.gz"),          emit: atac_gz, optional: true
    ...
    tuple val(meta), path("*.ATAC.sync.tsv.gz"),     emit: atac_sync_gz, optional: true
    ...
    tuple val(meta), path("*.ATAC.ontarget.tsv.gz"), emit: atac_ontarget_gz, optional: true
    ...
    tuple val(meta), path("*.ATAC.ontarget.sync.tsv.gz"), emit: atac_ontarget_sync_gz, optional: true
    tuple val(meta), path("*.ATAC.ontarget.sync.parquet"), emit: atac_ontarget_sync_parquet, optional: true
    
    // Region MDS outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.MDS.exon.tsv"),         emit: mds_exon, optional: true
    tuple val(meta), path("*.MDS.exon.tsv.gz"),      emit: mds_exon_gz, optional: true
    ...
    tuple val(meta), path("*.MDS.gene.tsv.gz"),      emit: mds_gene_gz, optional: true
    tuple val(meta), path("*.MDS.gene.parquet"),     emit: mds_gene_parquet, optional: true
    
    
    // mFSD outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.mFSD.tsv"),             emit: mfsd, optional: true
    tuple val(meta), path("*.mFSD.tsv.gz"),          emit: mfsd_gz, optional: true
    ...
    tuple val(meta), path("*.mFSD.distributions.tsv.gz"), emit: mfsd_dist_gz, optional: true
    tuple val(meta), path("*.mFSD.distributions.parquet"), emit: mfsd_dist_parquet, optional: true
    
    // UXM outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.UXM.tsv"),              emit: uxm, optional: true
    tuple val(meta), path("*.UXM.tsv.gz"),           emit: uxm_gz, optional: true
    tuple val(meta), path("*.UXM.parquet"),          emit: uxm_parquet, optional: true
    
    // GC correction outputs — TSV/TSV.gz/Parquet
    tuple val(meta), path("*.correction_factors.tsv"), emit: gc_factors, optional: true
    tuple val(meta), path("*.correction_factors.tsv.gz"), emit: gc_factors_gz, optional: true
    ...
    tuple val(meta), path("*.correction_factors.ontarget.tsv.gz"), emit: gc_factors_ontarget_gz, optional: true
