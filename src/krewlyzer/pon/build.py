...
def build_pon(
    ...
    memory_per_sample: float = typer.Option(12.0, "--memory-per-sample", help="Expected peak memory per sample in GB (for auto mode). Panel data: 12-20 GB, WGS: 4-8 GB"),
    sample_timeout: int = typer.Option(3600, "--sample-timeout", help="Max seconds per sample (0=no timeout). Default: 3600 (1 hour)"),
