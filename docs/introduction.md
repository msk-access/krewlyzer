...
> Already familiar? Skip to [Getting Started](getting-started.md).
...
2. **[Getting Started](getting-started.md)** - Your first analysis in 5 minutes
...
See [Citation & Scientific Background](citation.md) for complete references.
