...
See [Citation & Scientific Background](../citation.md#region-mds) for methodology details.
...
The tool supports two formats (see [Input Formats](../advanced/input-formats.md)):
